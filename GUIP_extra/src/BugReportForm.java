...
/** GUI forma za prijavljivanje bugova, uključuje polja za podatke o prijavitelju i detaljima greške
 */
public class BugReportForm extends JFrame {
    ...
    /** Stvara GUI za formu sa svim elementima
     * Inicijalizira strukturu forme i postavlja action listener za botune
     */
    ...
    /** Provjerava ako je svako polje forme ispunjeno, ako je formu ce staviti u tablicu, uprotivnom izbacuje error */
    ...
    /** Sprema prijavljene bugove koji se zatim mogu učitati u tablicu */
    ...
    /** Učitava datoteku koja sadrži prijavljene greške sustava */
    ...
    /** Inicijalizira i prikazuje GUI za formu */
